    ...
    <div className="group relative mb-8">
      ...
      >
        ...
        <div className="relative h-64 mb-4 overflow-hidden rounded-xl">
          ...
          {/* Popular badge */}
          {dish.popular && (
            <div className="absolute bottom-4 right-4 bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 text-white px-3 py-1 rounded-full text-sm font-black animate-pulse flex items-center gap-1">
